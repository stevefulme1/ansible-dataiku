...
def create_resource(client, params):
    ...
    return client.post("/public/api/admin/code-envs/", data=payload)
...
def update_resource(client, existing, params):
    ...
    return client.put(f"/public/api/admin/code-envs/{lang}/{resource_id}", data=payload)


def delete_resource(client, existing):
    """Delete a resource."""
    resource_id = existing.get("id", existing.get("code_env_id", ""))
    client.delete(f"/public/api/admin/code-envs/{lang}/{resource_id}")
