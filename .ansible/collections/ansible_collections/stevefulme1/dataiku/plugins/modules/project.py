...
def create_resource(client, params):
    ...
    return client.post("/public/api/projects/", data=payload)
...
def update_resource(client, existing, params):
    ...
    return client.put(f"/public/api/projects/{resource_id}", data=payload)


def delete_resource(client, existing):
    """Delete a resource."""
    resource_id = existing.get("id", existing.get("project_id", ""))
    client.delete(f"/public/api/projects/{resource_id}")
