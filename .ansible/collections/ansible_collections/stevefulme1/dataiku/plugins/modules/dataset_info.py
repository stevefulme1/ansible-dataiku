...
"""Ansible module to query Dataiku DSS dataset resources."""
...
---
module: dataset_info
short_description: List or retrieve DSS datasets
description:
    - Retrieve information about Dataiku DSS dataset resources.
version_added: "1.0.0"
author:
...
- name: List all datasets
  stevefulme1.dataiku.dataset_info:
...
def main():
    ...
    if params.get("project_key"):
        ...
        result = client.get(f"/public/api/projects/{params.get('project_key', '')}/datasets/")
