...
"""Ansible module to query Dataiku DSS project resources."""
...
---
module: project_info
short_description: List or retrieve DSS projects
description:
    - Retrieve information about Dataiku DSS project resources.
version_added: "1.0.0"
author:
...
- name: List all projects
  stevefulme1.dataiku.project_info:
...
def main():
    ...
    if params.get("project_key"):
        result = client.get(f"/public/api/projects/{params['project_key']}")
        module.exit_json(changed=False, projects=[result] if result else [])
    else:
        result = client.get("/public/api/projects/")
